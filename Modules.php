...
foreach($_openSIS['Menu'] as $modcat=>$programs)
{
	if(count($_openSIS['Menu'][$modcat]))
	{
		...
		{
			echo "<li><a style='cursor:hand;' HREF=# onmouseup='check_content(\"ajax.php?modname=$modcat/Search.php\");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \"".str_replace('_',' ',$modcat)."\";document.getElementById(\"cframe\").src = \"Bottom.php?modcat=".$modcat."\"'><span>School Info</span></a></li>";
		}
		elseif(User('PROFILE')!='admin' && $modcat=="Users")
		{
			echo "<li><a style='cursor:hand;' HREF=# onmouseup='check_content(\"ajax.php?modname=$modcat/Search.php\");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \"".str_replace('_',' ',$modcat)."\";document.getElementById(\"cframe\").src = \"Bottom.php?modcat=".$modcat."\"'><span>My Info</span></a></li>";
		}
		...
		{
			echo "<li><a style='cursor:hand;' HREF=# onmouseup='check_content(\"ajax.php?modname=$modcat/Search.php\");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \"".str_replace('_',' ',$modcat)."\";document.getElementById(\"cframe\").src = \"Bottom.php?modcat=".$modcat."\"'><span>Schedule</span></a></li>";
		}
		else
		{
