...
#	echo "<FIELDSET><TABLE>";
 ...
 echo "<TR ALIGN=LEFT><TD class='label'><b>School Logo: </b></td><td><table><tr><td><div align=center><a href ='Modules.php?modname=School_Setup/UploadLogo.php&modfunc=edit'><img src='".$uploaded_sql[1]['VALUE']."' width=70 class=pic /></a></div></td><td><a href ='Modules.php?modname=School_Setup/UploadLogo.php&modfunc=edit'>Click here to <br />change logo</a></td></tr></table></TD></TR>";
